        ...
        <div className="container mx-auto relative z-20">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Join our exciting lineup of workshops, competitions, and
              networking events
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Master the art of dynamic programming with real-world examples and practice problems.",
                color: "blue",
              },
              {
                type: "Competition",
                ...
                description:
                  "Test your skills in our annual winter programming competition with amazing prizes.",
                color: "yellow",
              },
              {
                type: "Networking",
                ...
                description:
                  "Connect with industry professionals and learn about career opportunities in tech.",
                color: "green",
              },
            ].map((event) => (
              <motion.div
